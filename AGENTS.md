...
- When locating fixture files or test resources, prefer `codex_utils_cargo_bin::find_resource!` over `env!("CARGO_MANIFEST_DIR")` so paths remain stable after `chdir`.
